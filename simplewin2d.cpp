...
drawingSurface::~drawingSurface() {
  /* MAU:  DeleteObject(scratchPadBitmap); */
  free(windowContents);
}
...
// coordinates
/*************************************************************************/
void drawingSurface::display(int x, int y /* MAU: HWND windowHandle*/) {
  printf("drawingSurface::display %d, %d\n", x, y);
  /* MAU:
...
// program's instance.
/*************************************************************************/
bitmapWindow::bitmapWindow(int x, int y, int width, int height/* MAU:, HINSTANCE currentInstance*/) 
{
...
bitmapWindow::~bitmapWindow() {
  // MAU: DestroyWindow(windowHandle);
  // MAU: numberOfBitmapWindows--;
}
